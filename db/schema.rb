...
ActiveRecord::Schema.define(version: 2021_10_12_124007) do
  ...
  create_table "answerings", charset: "utf8mb4", force: :cascade do |t|
    t.bigint "task_id", null: false
    t.bigint "answer_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["answer_id"], name: "index_answerings_on_answer_id"
    t.index ["task_id"], name: "index_answerings_on_task_id"
  end
  ...
  create_table "taskuseranswers", charset: "utf8mb4", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["task_id"], name: "index_taskuseranswers_on_task_id"
  end
